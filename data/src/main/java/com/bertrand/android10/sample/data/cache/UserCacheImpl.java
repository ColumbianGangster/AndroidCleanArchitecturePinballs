...
import com.bertrand.android10.sample.data.cache.serializer.Serializer;
import com.bertrand.android10.sample.data.entity.PinballMatchEntity;
import com.bertrand.android10.sample.data.exception.UserNotFoundException;
...
public class UserCacheImpl implements UserCache {
  ...
  @Override public void put(PinballMatchEntity pinballMatchEntity) {
    if (pinballMatchEntity != null) {
      final File userEntityFile = this.buildFile(pinballMatchEntity.getUserId());
      if (!isCached(pinballMatchEntity.getUserId())) {
        final String jsonString = this.serializer.serialize(pinballMatchEntity, PinballMatchEntity.class);
